  ...
  return (
    <main className="fixed inset-0 z-[998] bg-white flex flex-col items-center justify-between px-6 py-10">
      ...
      <div className="text-center max-w-xs">
        <h2 className="text-xl font-bold mb-2 pry-ff mt-1">{slides[step].title}</h2>
        <p className="text-sm text-gray-600 sec-ff">{slides[step].desc}</p>
      </div>
