...
function OrderCard({
            ...
            <div className="px-4 pb-3 flex flex-col gap-2">
                <div className="flex items-center justify-between gap-2">
                    ...
                    <a href={mapsUrl}
                        ...
                        className="flex items-center gap-1 text-xs text-[#006B4F] font-medium hover:underline shrink-0"
                    >
                    <Navigation size={10} />
                    View Map
                </a>
    ...
    <div className="grid grid-cols-2 gap-3 px-4 pb-4">
        <button
            ...
            disabled={claiming}
            className="flex items-center justify-center gap-2 py-3 rounded-xl bg-[#006B4F] hover:bg-[#005540] disabled:opacity-60 text-white text-sm font-semibold transition-colors"
        >
            {claiming ? <Loader2 size={14} className="animate-spin" /> : null}
            Accept
        </button>
        <button
            onClick={() => onDeclined(order._id)}
            disabled={claiming}
            className="py-3 rounded-xl bg-red-600 hover:bg-red-700 disabled:opacity-60 text-white text-sm font-semibold transition-colors"
        >
            Decline
        </button>
    </div>
