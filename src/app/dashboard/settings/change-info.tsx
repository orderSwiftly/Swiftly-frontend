...
export default function ChangeInfo() {
  ...
  return (
    <div className="w-full max-w-md bg-white/5 border border-white/10 p-6 rounded-lg shadow-md pry-ff text-[var(--txt-clr)]">
      <h1 className="text-2xl font-bold mb-6 text-[var(--acc-clr)]">Change Personal Info</h1>
